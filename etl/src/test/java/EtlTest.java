// Unlike Collections.unmodifiableMap(java.util.Map), which is a view of
// a separate map which can still change, an instance of ImmutableMap contains
// its own data and will never change. ImmutableMap is convenient for public static
// final maps ("constant maps") and also lets you easily make a "defensive copy"
// of a map provided to your class by a caller.
